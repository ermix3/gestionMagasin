...
class Magasin:
    ...
    def ajouter_produit(self, produit)->None:
        try:
            ...
            print(f"Le produit {produit.code} a été ajouté")
    ...
    def supprimer_produit(self, code)->None:
        try:
            if type(self.chercher_produit(code)) == Livre or type(self.chercher_produit(code)) == CD:
                ...
                print(f"Le produit {code} a été supprimé")
        except ProduitInexistantException:
                print(f"Le produit {code} n'existe pas")
    ...
    def chercher_produit(self, code)->Produit:
        for p in self.liste_produits:
            ...
            raise ProduitInexistantException(f"Le produit {code} n'existe pas")
